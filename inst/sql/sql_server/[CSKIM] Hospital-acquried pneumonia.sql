...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1790868,1713332,1717327,1734104,1715117,1771162,1747005,1748975,1774470,1749008,1776684,1777806,1797513,1750500,901845,1738521,1746940,1716721,1778262,1742253,1736887,1709170,1716903,1713930,1724703,1746114,948582,19063874,902722,1707687)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1790868,1713332,1717327,1734104,1715117,1771162,1747005,1748975,1774470,1749008,1776684,1777806,1797513,1750500,901845,1738521,1746940,1716721,1778262,1742253,1736887,1709170,1716903,1713930,1724703,1746114,948582,19063874,902722,1707687)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42920760,42921484,42921086,42918032,19075378,43166939,43177991,19080152,19102471,42972347,902741)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (42920760,42921484,42921086,42918032,19075378,43166939,43177991,19080152,19102471,42972347,902741)
  and c.invalid_reason is null
...
(
  select po.* 
  FROM @cohort_database_schema.PROCEDURE_OCCURRENCE po
...
JOIN @cohort_database_schema.OBSERVATION_PERIOD OP on Q.person_id = OP.person_id 
...
(
  select m.* 
  FROM @cohort_database_schema.MEASUREMENT m
